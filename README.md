...
| 工程 | macOS 桌面封装、本地数据空间、MT4/MT5 Bridge、状态驱动提醒、自动报告和 316 项自动化测试 |
...
| MT4/MT5 不是静态界面演示 | Bridge 账户发现、持仓读取测试；MT5 演示账户端到端验证 |
| 交易隐私具有明确边界 | 本地令牌、敏感字段裁剪、文件权限与只读验收 |
...
- MT5 已完成演示账户端到端验证，MT4 使用同一 Bridge 契约完成实现与自动化验证；
